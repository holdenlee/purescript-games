    ...
    return function (cond) {
        return function (ma) {
            return Control_Bind.bind(dictMonad["__superclass_Control.Bind.Bind_1"]())(ma)(function (v) {
                ...
                throw new Error("Failed pattern match at Snake line 191, column 7 - line 191, column 48: " + [ $27.constructor.name ]);
            });
        };
    };
};
...
var ifs = function (__copy_li) {
    return function (__copy_z) {
        ...
        var z = __copy_z;
        tco: while (true) {
            var $35 = Data_Array.uncons(li);
            if ($35 instanceof Data_Maybe.Just) {
                if ($35.value0.head.value0) {
                    return $35.value0.head.value1;
                };
                if (!$35.value0.head.value0) {
                    var __tco_z = z;
                    li = $35.value0.tail;
                ...
                throw new Error("Failed pattern match at Snake line 181, column 52 - line 181, column 77: " + [ $35.value0.head.value0.constructor.name ]);
            };
            if ($35 instanceof Data_Maybe.Nothing) {
                return z;
            };
            throw new Error("Failed pattern match at Snake line 180, column 12 - line 182, column 34: " + [ $35.constructor.name ]);
        };
    };
};
...
var step = function (dictPartial) {
    return function (dir) {
        return function (m) {
            var d = (function () {
                var $48 = Data_Eq.notEq(Data_Tuple.eqTuple(Data_Eq.eqInt)(Data_Eq.eqInt))(dir)(new Data_Tuple.Tuple(0, 0));
                if ($48) {
                    return dir;
                };
                if (!$48) {
                ...
                throw new Error("Failed pattern match at Snake line 67, column 9 - line 69, column 19: " + [ $48.constructor.name ]);
            })();
            ...
            var $49 = checkOK(hd)(m);
            if ($49) {
                var $50 = Data_Eq.eq(Data_Tuple.eqTuple(Data_Eq.eqInt)(Data_Eq.eqInt))(hd)(m.mouse);
                if ($50) {
                    return Control_Bind.bind(Test_QuickCheck_Gen.bindGen)(untilM(Test_QuickCheck_Gen.monadGen)(function (pt) {
                        ...
                        return Control_Applicative.pure(Test_QuickCheck_Gen.applicativeGen)((function () {
                            var $52 = {};
                            for (var $53 in m) {
                                if (m.hasOwnProperty($53)) {
                                    $52[$53] = m[$53];
                                };
                            };
                            $52.snake = Data_Array.cons(hd)(m.snake);
                            $52.mouse = v;
                            $52.dir = d;
                            $52.prev = Data_Maybe.Nothing.value;
                            return $52;
                        })());
                    });
                };
                if (!$50) {
                    return Control_Applicative.pure(Test_QuickCheck_Gen.applicativeGen)((function () {
                        var $55 = {};
                        for (var $56 in m) {
                            if (m.hasOwnProperty($56)) {
                                $55[$56] = m[$56];
                            };
                        };
                        $55.snake = Data_Array.cons(hd)(body(m.snake));
                        $55.dir = d;
                        $55.prev = Data_Array.last(m.snake);
                        return $55;
                    })());
                };
                throw new Error("Failed pattern match at Snake line 75, column 9 - line 87, column 25: " + [ $50.constructor.name ]);
            };
            if (!$49) {
                return Control_Applicative.pure(Test_QuickCheck_Gen.applicativeGen)((function () {
                    var $58 = {};
                    for (var $59 in m) {
                        if (m.hasOwnProperty($59)) {
                            $58[$59] = m[$59];
                        };
                    };
                    $58.alive = false;
                    $58.prev = Data_Maybe.Nothing.value;
                    return $58;
                })());
            };
            throw new Error("Failed pattern match at Snake line 73, column 5 - line 88, column 55: " + [ $49.constructor.name ]);
        };
    };
};
var blue = "#0000FF";
    ...
    return function (m) {
        return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
            ...
            return __unused(dictPartial)((function () {
                ...
                throw new Error("Failed pattern match at Snake line 120, column 3 - line 144, column 52: " + [ v.constructor.name ]);
            })())();
        });
    };
};
    ...
    return function (m) {
        return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
            ...
            return __unused(dictPartial)((function () {
                ...
                throw new Error("Failed pattern match at Snake line 105, column 3 - line 113, column 55: " + [ v.constructor.name ]);
            })())();
        });
    };
};
var main = Data_Functor["void"](Control_Monad_Eff.functorEff)(Partial_Unsafe.unsafePartial(function (dictPartial) {
    return function __do() {
        ...
        return Signal.runSignal(Data_Functor.map(Signal.functorSignal)(renderStep(dictPartial))(v2))();
    };
}));
module.exports = {
    bgColor: bgColor, 
